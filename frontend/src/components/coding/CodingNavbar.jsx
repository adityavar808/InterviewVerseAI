      ...
      <div className="relative flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <div className="px-4 py-1 rounded-full bg-green-500/10 border border-green-500/20 text-green-400 text-sm">
              Easy
            </div>
      ...
      <div className="relative mt-6 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-white/10 rounded-2xl p-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm text-gray-300 leading-relaxed">
            AI interviewer will analyze your solution,
            optimization approach, coding style, and
            time complexity after submission.
          </p>
        </div>
      </div>
    </motion.div>
