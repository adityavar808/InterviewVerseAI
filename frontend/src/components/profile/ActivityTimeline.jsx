      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-3.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-white leading-tight">Activity Timeline</h2>
              <p className="text-[11px] text-slate-400">Recent profile and interview activity</p>
            </div>
          </div>
