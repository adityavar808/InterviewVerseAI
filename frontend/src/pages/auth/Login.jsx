...
const Login = () => {
  ...
  return (
    <div className="relative min-h-screen bg-[#020617] flex items-center justify-center px-4 overflow-hidden">
      ...
      {/* Ambient orbs */}
      <div
        className="absolute w-80 h-80 rounded-full pointer-events-none top-[-80px] left-[-80px]"
        style={{
          background:
      ...
      />
      <div
        className="absolute w-72 h-72 rounded-full pointer-events-none bottom-[-60px] right-[-60px]"
        style={{
          background:
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl text-sm text-slate-100 outline-none transition-all duration-200 placeholder:text-slate-600"
              style={{
                background: "rgba(255,255,255,0.04)",
                border: "1px solid rgba(255,255,255,0.08)",
              }}
